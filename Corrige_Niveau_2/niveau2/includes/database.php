<?php
    ...
    const DATABASE_TABLE_UTILISATEURS = "utilisateurs" ;
    const DATABASE_TABLE_UTILISATEURS_ID = "id" ;
    ...
    const DATABASE_TABLE_UTILISATEURS_PASSWORD = "password" ;
